<template>
  <div class="randomizer">
    ...
    <button @click="randomizeCard" class="fantasy-btn fantasy-bone-n-coper">Randomize</button>
  </div>
</template>
...
@layer fantasy-btn {
  ...
  [class*="fantasy-btn"]:focus {
    ...
    --_text-state-shadow: var(--text-focus-shadow);
    --_outline-state-size: 0px; /* Ensure no outline size */
    --_outline-state-style: none; /* Ensure no outline style */
    --_outline-state-color: transparent; /* Ensure no outline color */
    --_outline-state-offset: 0px;
  }
